  ...
  return (
    <div className="min-h-screen flex bg-background">
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-between p-8 lg:p-16">
        <div className="flex-1 flex flex-col justify-center max-w-md mx-auto w-full">
          ...
          <Button
            type="button"
            variant="outline"
            className="w-full h-12 mb-4 text-foreground border-border hover:bg-accent"
          ...
          <form onSubmit={isSignUp ? handleSignUp : handleSignIn} className="space-y-4">
            ...
            <Button 
              type="submit" 
              className="w-full h-12 bg-[hsl(220,60%,25%)] hover:bg-[hsl(220,60%,20%)] text-white font-medium"
              disabled={isLoading}
            >
      ...
      <div className="hidden lg:flex w-1/2 bg-muted/30 flex-col items-center justify-center p-8 relative overflow-hidden">
        ...
        <div className="absolute top-8 right-8 grid grid-cols-3 gap-1 opacity-30">
          {[...Array(9)].map((_, i) => (
            <div key={i} className="w-1.5 h-1.5 rounded-full bg-primary/50"></div>
          ))}
        </div>
        <div className="absolute bottom-12 left-12 grid grid-cols-3 gap-1 opacity-30">
          {[...Array(9)].map((_, i) => (
            <div key={i} className="w-1.5 h-1.5 rounded-full bg-primary/50"></div>
          ))}
        </div>
